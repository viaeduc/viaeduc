...
class MyQuestionGroupType extends AbstractType
{
    private $context;
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(array(
            ...
            'empty_value'        => 'Dans mes questions',
            'query_builder'      => function ($repo) {
                return $repo->createQueryBuilder('g')
                    ...
                    ->setParameters(array(
                        ...
                        'module_meta_key'   => 'group.modules.enabled.questions'
                    ))
                ;
            }
        ));
