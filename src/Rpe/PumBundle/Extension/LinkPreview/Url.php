...
class  Url {
    ...
    static public function canonicalLink($imgSrc, $referrer) {
        if (strpos($imgSrc, "//") === 0)
            $imgSrc = "http:" . $imgSrc;
    ...
    static public function canonicalImgSrc($imgSrc) {
    ...
    static public function canonicalRefererPage($url) {
        $canonical = "";
        $barCounter = 0;
    ...
    static public function canonicalPage($url) {
        $canonical = "";
    ...
    static public function getImageUrl($pathCounter, $url) {
        $src = "";
        if ($pathCounter > 0) {
